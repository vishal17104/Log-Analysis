...
<style> 
    ...
    section[data-testid="stSidebar"] { background-color: #0e1117 !important; border-right: 1px solid #1e2130; } 
    div[data-testid="stMetric"] { background-color: #1e2130; border: 1px solid #2d313e; border-radius: 12px; padding: 20px !important; } 
    div[data-testid="stMetricLabel"] { color: #808495 !important; font-size: 13px !important; } 
    div[data-testid="stMetricValue"] { color: white !important; font-size: 30px !important; } 
...
# Fetching data globally to be used across pages
stats = get_stats()
...
# # ---------------- INCIDENT PAGE ---------------- #
    ...
    # This renders the sleek cards based on your incident_view.py
...
# # ---------------- LOGS EXPLORER ---------------- #
    ...
    if logs:
        ...
        # Simple local filtering for the UI
        if search_query:
